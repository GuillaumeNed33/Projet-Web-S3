            ...
            <div class="modal-body">
                <form action="data/connexion.php" method="post">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Login" aria-describedby="basic-addon1" name="login" required>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon glyphicon glyphicon-lock" id="basic-addon1"></span>
                        <input type="password" class="form-control" placeholder="Password" aria-describedby="basic-addon2" name="pass" required>
                    </div>
            ...
            <div class="collapsing" id="collapseRegister">
                <div class="well">
                    ...
                    <form action="data/inscription.php" method="post" class="text-center" required>
                        ...
                        <label>Confirmation Password</label><input class="form-control" name="passConf1" type="password" required>
                        <label>Adresse</label><input class="form-control" name="adresse1" type="text">
