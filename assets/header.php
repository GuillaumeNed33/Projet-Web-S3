                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="modal-footer">
                                <a role="button" data-toggle="collapse" href="#collapseRegister" aria-expanded="false" aria-controls="collapseRegister"><b>Not a member yet? Register now !</b></a>
                                ...
                                <div class="collapsing" id="collapseRegister">
                                  <div class="well">
                                    ...
                                    <form action="data/inscription.php" method="post" class="text-center">
                                      <label id="Label1">Nom </label><input name="nom" type="text"><br>
                                      <label id="Label2">Prénom </label><input name="prenom" type="text"><br>
                                      <label id="Label3">Login </label><input name="login" type="text"><br>
                                      <label id="Label4">Password </label><input name="pass" type="password"><br>
                                      <label id="Label5">Adresse * </label><input name="adresse" type="text"><br>
                                      <label id="Label6">Code Postal * </label><input name="code" type="text"><br>
                                      <label id="Label7">Ville * </label><input name="ville" type="text"><br>
                                      <label id="Label9">E-mail *</label><input name="mail" type="text"><br>
                                      Pays *
                                      <select name="pays" class="browser-default">
                                        <option>LOL</option>
                                        <option>LOL</option>
                                        <option>LOL</option>
                                        <option>LOL</option>
